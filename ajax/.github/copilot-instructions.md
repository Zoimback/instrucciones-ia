...
2. Revisa el Contributing.md del proyecto para entender las normas de codificación y flujo de trabajo. Ten especial cuidado en como se debe subir el codigo.
...
img/
  tratadas/ -> Imagenes optimizadas en formato .webp
